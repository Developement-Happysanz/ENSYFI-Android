...
import com.palprotech.ensyfi.customview.caldroid_calendar.customcalendarpage.InfinitePagerAdapter;
import com.palprotech.ensyfi.customview.caldroid_calendar.customcalendarpage.InfiniteViewPager;
...
public class CaldroidFragment extends DialogFragment {
   ...
   * @param odDates
   */
  public void setOdDates(ArrayList<Date> leaveDateList) {
  ...
  /**
   * Set leaveDates from ArrayList of Date
   *
   * @param leaveDateList
   */
  public void setLeaveDates(ArrayList<Date> leaveDateList) {
    if (leaveDateList == null || leaveDateList.size() == 0) {
      return;
    }
  ...
  /**
   * Set leaveDates from ArrayList of String. By default, the date formatter
   * is yyyy-MM-dd. For e.g 2013-12-24
   *
   * @param leaveDateStrings
   */
  public void setLeaveDatesFromString(ArrayList<String> leaveDateStrings) {
    setLeaveDatesFromString(leaveDateStrings, null);
  }

  /**
   * Set leaveDates from ArrayList of String with custom date format. For
   * example, if the date string is 06-Jan-2013, use date format dd-MMM-yyyy.
   * This method will refresh the calendar, it's not necessary to call
   * refreshView()
   *
          ...
          if (caldroidListener != null) {
            if (!enableClickOnDisabledDates) {
              if ((minDateTime != null && dateTime.lt(minDateTime))
                      ...
                      || (leaveDates != null && leaveDates.indexOf(dateTime) != -1)) {
                return;
              }
            }
   ...
   * dialogTitle, showNavigationArrows,(String) disableDates, leaveDates, selectedDates,
  ...
  protected void retrieveInitialArgs() {
    ...
    if (args != null) {
      ...
      // Get leave dates
      ArrayList<String> leaveDateStrings = args.getStringArrayList(LEAVE_DATES);
