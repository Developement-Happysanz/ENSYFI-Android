...
public class StudentsAcademicExamMarksAddOnlyTotalBaseAdapter extends BaseAdapter {
    ...
    public StudentsAcademicExamMarksAddOnlyTotalBaseAdapter(Context context, ArrayList<StudentsClassTestMarks> myList) {
        this.myList = myList;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.students_academic_exam_marks_add_only_total_list_item, parent, false);
