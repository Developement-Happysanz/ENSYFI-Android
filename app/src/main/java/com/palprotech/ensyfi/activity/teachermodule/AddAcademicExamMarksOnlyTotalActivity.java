...
public class AddAcademicExamMarksOnlyTotalActivity extends AppCompatActivity implements View.OnClickListener, DialogClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        StudentsAcademicExamMarksAddBaseAdapter cadapter = new StudentsAcademicExamMarksAddBaseAdapter(AddAcademicExamMarksOnlyTotalActivity.this, myList);
    ...
    private boolean validateFields() {
        ...
        for (int i = 0; i < lvStudent.getCount(); i++) {
            edtMarks = (EditText) lvStudent.getChildAt(i).findViewById(R.id.internal_marks);
...
//            et = (TextView) lvStudent.getChildAt(i).findViewById(R.id.txt_studentId);
            ...
            if (!AppValidator.checkNullString(edtMarks.getText().toString().trim())) {
                AlertDialogHelper.showSimpleAlertDialog(this, "Enter valid mark for student - " + String.valueOf(et1.getText()));
//                return false;
            }
...
//                    Toast.LENGTH_LONG).show();
            for (int i = 0; i < lvStudent.getCount(); i++) {
                ...
                if (et != null) {
                    ...
                    long c = db.academic_exam_marks_insert(examId, teacherId, subjectId, studentId, classMasterId, mark,
                            grade, externalMark, externalGrade, totalMarks, totalGrade, createdBy, createdAt,
