...
public class RefreshExamAndExamDetails implements IServiceListener {
    ...
    public RefreshExamAndExamDetails(Context context) {
        this.context = context;
    }

    public void ReloadExamAndExamDetails() {
